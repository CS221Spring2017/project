...
int main(int argc, const char* argv[])
{
    ...
    int file = open("data/cache", O_RDONLY | O_SYNC);
    /*
    ...
    */
    ...
    //Read the file again
    file = open("data/cache", O_RDONLY | O_SYNC);
    total_bytes = 0;
    /*
     if(lseek(file, FILE_SIZE -1, SEEK_SET) == -1)
     {
    ...
    double answer = total*1.0/(FILE_SIZE/BLOCK_SIZE);
    printf("cycle = %lf \n", answer);
}
